...
IF OBJECT_ID('bronze.epidemiology','U') IS NOT NULL DROP TABLE bronze.epidemiology;
...
IF OBJECT_ID('bronze.hospitalizations','U') IS NOT NULL DROP TABLE bronze.hospitalizations;
...
IF OBJECT_ID('bronze.deaths','U') IS NOT NULL DROP TABLE bronze.deaths;
...
IF OBJECT_ID('bronze.mobility','U') IS NOT NULL DROP TABLE bronze.mobility;
...
IF OBJECT_ID('bronze.demographics','U') IS NOT NULL DROP TABLE bronze.demographics;
...
IF OBJECT_ID('bronze.us_counties_2022','U') IS NOT NULL DROP TABLE bronze.us_counties_2022;
...
IF OBJECT_ID('bronze.lawatlas_emergency_declarations','U') IS NOT NULL DROP TABLE bronze.lawatlas_emergency_declarations;
...
WHERE s.name = 'bronze'
  AND t.name IN (
    'epidemiology', 'hospitalizations', 'deaths', 'mobility',
    'demographics', 'lawatlas_emergency_declarations', 'us_counties_2022'
  )
